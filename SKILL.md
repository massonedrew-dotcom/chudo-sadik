---
name: chudo-sadik-design
description: Use this skill to generate well-branded interfaces and assets for Чудо Садик (Miracle Kindergarten, by Color Baby House) — a warm, bright kindergarten brand for children aged 1–7 — either for production or throwaway prototypes/mocks. Contains essential design guidelines, colours, type, fonts, assets, and UI-kit components for prototyping.
user-invocable: true
---

# Чудо Садик — design skill
...
- `assets/` — the logo: `logo-chudo.png` (original), `logo-chudo-transparent.png` (full lockup, transparent), `logo-sun.png` (sun mark only).
