...
function Programs() {
  ...
  const programs = [
    ...
    { t: 'Гимнастика', d: 'Здоровье, осанка и ловкость каждый день.', i: 'activity', c: 'sky', g: 'Движение' },
    { t: 'Массаж (курс)', d: 'Оздоровительный курс под присмотром специалиста.', i: 'heart-handshake', c: 'mint', g: 'Движение' },
    ...
    { t: 'Робототехника', d: 'Первые шаги в технике и конструировании.', i: 'bot', c: 'mint', g: 'Логика' },
  ];
