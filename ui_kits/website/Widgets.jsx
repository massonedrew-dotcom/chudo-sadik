/* Чудо Садик — мелкие сквозные виджеты: кнопка «наверх» и cookie-уведомление */
  ...
  return (
    <button
      ...
      style={{
        ...
        border: '2px solid var(--pink-200, #FFC2DA)', background: 'rgba(255,255,255,0.94)',
  ...
  return (
    <div role="dialog" aria-label="Использование cookie" style={{
      ...
      <p style={{
        ...
        Подробнее — в{' '}
        <a href={asset('privacy.html')} style={{ color: 'var(--color-primary)', fontWeight: 700 }}>
