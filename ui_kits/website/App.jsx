...
function App() {
  ...
  const blobs = [
    { c: '#FFAFD3', x: '10%', y: '14%', s: '540px', t: '34s', d: '0s',   dx: '90px',  dy: '70px'  },
    { c: '#FFD980', x: '82%', y: '10%', s: '460px', t: '41s', d: '-8s',  dx: '-80px', dy: '90px'  },
    { c: '#A8E4FF', x: '70%', y: '52%', s: '600px', t: '47s', d: '-16s', dx: '70px',  dy: '-80px' },
    { c: '#C9BCFF', x: '16%', y: '74%', s: '520px', t: '38s', d: '-24s', dx: '-70px', dy: '-60px' },
    { c: '#A6EFD0', x: '46%', y: '88%', s: '440px', t: '44s', d: '-12s', dx: '60px',  dy: '-90px' },
  ];
  const balloons = [
    { c: '#FF6FA5', x: '7%',  t: '26s', d: '-2s',  drift: '46px'  },
    { c: '#7FD1F5', x: '21%', t: '33s', d: '-14s', drift: '-32px' },
    { c: '#FFD666', x: '38%', t: '29s', d: '-23s', drift: '38px'  },
    { c: '#B39DFF', x: '58%', t: '36s', d: '-7s',  drift: '-42px' },
    { c: '#7BDCB5', x: '74%', t: '30s', d: '-19s', drift: '30px'  },
    { c: '#FF8A5B', x: '89%', t: '38s', d: '-28s', drift: '-26px' },
  ];
  const clouds = [
